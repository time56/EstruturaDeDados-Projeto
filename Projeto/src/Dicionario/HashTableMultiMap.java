package Dicionario; //Esta classe implementa a interface do TAD Dicionario MultiMap<K, V>
import java.util.AbstractMap; //As outras interfaces utilizadas são do próprio Java.
...
public class HashTableMultiMap<K, V> implements MultiMap<K, V> {
	...
	//Retorna um iterador contendo todas as entradas contendo uma certa chave ou um iterado vazio se a entrada não existir.
